repo_image_name_styled := "ublue-base"
repo_image_name := "ublue-base"
repo_name := "hecknt"
username := "hecknt"
images := '(
    [base]="base-main"
    [nvidia]="base-nvidia"
    [kernel-cachyos]="base-main"
    [kernel-cachyos-nvidia]="base-nvidia"
)'
...
# Build ISO
[group('ISO')]
build-iso image="ublue-base" ghcr="0" clean="0":
    #!/usr/bin/env bash
    set ${SET_X:+-x} -eou pipefail
    # Validate
    declare -A images={{ images }}
